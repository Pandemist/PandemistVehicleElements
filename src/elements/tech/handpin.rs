...
///
/// ```rust
/// let hand_pin = HandPin::builder("x_anim", "y_anim", Some(CockpitSide::A))
///     .mouse_factor(2.0)
...
///
/// ```rust
/// use pandemist_vehicle_elements::HandPin;
/// use lotus_extra::vehicle::CockpitSide;
///
/// // Create a HandPin with custom settings
/// let mut hand_pin = HandPin::builder("x_movement", "y_movement", Some(CockpitSide::A))
///     .mouse_factor(1.5)
...
impl HandPin {
    ...
    /// use lotus_extra::vehicle::CockpitSide;
    ///
    /// let builder = HandPin::builder("x_anim", "y_anim", Some(CockpitSide::A));
    /// ```
    pub fn builder(
