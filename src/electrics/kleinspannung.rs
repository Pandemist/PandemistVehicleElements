...
use crate::structs::internal_enums::SwitchingTarget;
...
impl Kleinspannung {
    pub fn new(
        init_const_batteriespannung_normal_v: f32,
        init_const_batteriespannung_max_v: f32,
        init_const_batteriespannung_min_v: f32,
        init_const_batteriespannung_loss_vs: f32,
        init_const_batteriespannung_load_vs: f32,
        init_voltage: f32,
        init_mainswitch: bool,
    ) -> Self {
        let mut kl = Kleinspannung {
            const_batteriespannung_normal_v: init_const_batteriespannung_normal_v,
            const_batteriespannung_max_v: init_const_batteriespannung_max_v,
            const_batteriespannung_min_v: init_const_batteriespannung_min_v,
            const_batteriespannung_loss_vs: init_const_batteriespannung_loss_vs,
            const_batteriespannung_load_vs: init_const_batteriespannung_load_vs,

            batteriespannung_abs: init_voltage,

            batterie_mainswitch: init_mainswitch,
            ..Default::default()
        };
