...
impl<T: MessageLine> UniversalCouplingLine<T> {
    ...
    pub fn get_value(&mut self) -> T {
        ...
        //
        //self.local_value
        //    .evaluate(&self.local_value, &self.local_value.evaluate(front, rear))
    }
    ...
    fn update(&mut self) {
        ...
        //    self.local_value.evaluate(&self.local_value, rear)
        //} else {
        //    self.local_value.clone()
        //};
        //let to_rear = if self.is_allowed.0 {
        //    self.local_value.evaluate(&self.local_value, front)
        //} else {
        //    self.local_value.clone()
        //};
